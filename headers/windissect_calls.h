...
static constexpr wchar_t module_name[18] = {0x0043, 0x006F, 0x0072, 0x0065, 0x004D, 0x0065, 0x0073, 0x0073, 0x0061, 0x0067, 0x0069, 0x006E, 0x0067, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 974823412U || rva >= image_size) return nullptr;
return base + rva;
}
