//! Windissect-generated Rust FFI bindings for CoreMessaging.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "46238A8B3F58B1B4DFE8CF4CB68533C0";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 974823412;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 18] = [67, 111, 114, 101, 77, 101, 115, 115, 97, 103, 105, 110, 103, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 974823412 { return 0; }
